import { Building2, Calendar, ExternalLink, X, Award, Code2, Lightbulb, MonitorSmartphone, MapPin } from "lucide-react";
            ...
            <div className="relative z-10">
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5 text-muted-foreground text-sm mt-1">
                        ...
                        <span>Coimbatore, Tamil Nadu · On-site</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-4 rounded-lg border border-primary/20 hover:border-primary/40 transition-all group/card">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h5 className="font-semibold text-foreground">Python · Go · ML</h5>
                  </div>
                  <p className="text-sm text-muted-foreground">Backend services, ML notebooks, and data pipelines</p>
                </div>
                <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-4 rounded-lg border border-primary/20 hover:border-primary/40 transition-all group/card">
                  <div className="flex items-center gap-2 mb-2">
                    <Award className="w-5 h-5 text-primary" />
                    <h5 className="font-semibold text-foreground">Version Migrations</h5>
                  </div>
                  <p className="text-sm text-muted-foreground">Managing platform upgrades and dependency migrations</p>
                </div>
              </div>
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex gap-3 group/item hover:bg-muted/20 p-3 rounded-lg transition-all">
                    ...
                    <span className="leading-relaxed">
                      Working on <span className="text-foreground font-medium">Athena</span>, a conversational insight platform, contributing to its React-based frontend and overall product experience.
                    </span>
                  </li>
                  <li className="flex gap-3 group/item hover:bg-muted/20 p-3 rounded-lg transition-all">
                    <span className="text-primary mt-1.5 flex-shrink-0 group-hover/item:scale-125 transition-transform">▸</span>
                    <span className="leading-relaxed">
                      Developing and maintaining <span className="text-foreground font-medium">backend services in Python and Go</span>, supporting API integrations and real-time data flows for the platform.
                    </span>
                  </li>
                  <li className="flex gap-3 group/item hover:bg-muted/20 p-3 rounded-lg transition-all">
                    <span className="text-primary mt-1.5 flex-shrink-0 group-hover/item:scale-125 transition-transform">▸</span>
                    <span className="leading-relaxed">
                      Contributing to <span className="text-foreground font-medium">ML notebooks</span> for model experimentation, data exploration, and insight generation pipelines.
                    </span>
                  </li>
                  <li className="flex gap-3 group/item hover:bg-muted/20 p-3 rounded-lg transition-all">
                    <span className="text-primary mt-1.5 flex-shrink-0 group-hover/item:scale-125 transition-transform">▸</span>
                    <span className="leading-relaxed">
                      Handling <span className="text-foreground font-medium">version migrations</span> across the platform stack, ensuring compatibility, stability, and smooth upgrades between releases.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {["React", "Python", "Go", "ML Notebooks", "Version Migrations", "Conversational AI"].map((tech, i) => (
                    <span
                      key={i}
